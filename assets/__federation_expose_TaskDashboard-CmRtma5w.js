...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/task-remote-app/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
function TaskDashboard() {
  ...
  const addTask = async () => {
    const { data: { session } } = await supabase.auth.getSession();
    const { data, error } = await supabase.from("tasks").insert([{ title: newTask, user_id: session?.user.id }]).select();
    if (!error && data) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Tasks" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: addTask, children: "Add" }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: tasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { onClick: () => toggleTask(task), children: task.completed ? /* @__PURE__ */ jsxRuntimeExports.jsx("s", { children: task.title }) : task.title }, task.id)) })
  ] });
}

export { TaskDashboard as default, jsxRuntimeExports as j };
